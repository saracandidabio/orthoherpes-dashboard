...
def load_records(data_dir: Path) -> pd.DataFrame:
    ...
    df["country_canonical"] = canonicalize_country(df["country_final"]).astype("category")
...
COUNTRY_ISO3 = {
    ...
    "Cape Verde": "CPV", "Cayman Islands": "CYM", "Central African Republic": "CAF",
    ...
    "Luxembourg": "LUX", "Macedonia": "MKD", "Madagascar": "MDG", "Malawi": "MWI",
